"""
Django settings for bicibackend project.
...
SECRET_KEY = 'wm*@64o4x54b3fjv8&fdqo=#s*8or2g^mgh2l$vzgn72gf#(1@'
...
# O caminho para os templates context processors mudou no Django 1.8, mas o django-allauth não mudou para isso. Então a gente tem que partir para a gambiarra
...
WSGI_APPLICATION = 'bicibackend.wsgi.application'
